...
from agent_sdk.transport.sender import Sender
from agent_sdk.modules.exception.exceptions import ExceptionTracker
from agent_sdk.modules.http.network import install_http_patch
from agent_sdk.modules.logging.logging_capture import install_logging
...
class Agent:
    ...
    def init(
        ...
        *,
        ...
        AgentConfig.DEBUG = DEBUG  # Set to True to enable debug mode (e.g., skip certain logs)
        ...
        if framework and app:
            ...
            if framework == "flask":
                from agent_sdk.modules.request.flask import init_flask
                init_flask(app)

            elif framework == "fastapi":
                from agent_sdk.modules.request.fastapi import init_fastapi
                init_fastapi(app)

            elif framework == "django":
                from agent_sdk.modules.request.django import init_django
                init_django()
        ...
        # ----------------------------
        if enable_db:
            from agent_sdk.modules.db.database import install_db_monitor
            install_db_monitor(db_engine)
